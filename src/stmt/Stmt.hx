...
class Stmt {
	...
	static var validTypes:Array<String> = [
		...
		"container_stmt", "default_stmt", "description_stmt", "enum_stmt", "error_app_tag_stmt", "error_message_stmt", "extension_stmt", "deviation_stmt",
		"deviate_stmt", "feature_stmt", "fraction_digits_stmt", "grouping_stmt", "identity_stmt", "if_feature_stmt", "import_stmt", "include_stmt",
		...
		"value_stmt", "when_stmt", "yang_version_stmt", "yin_element_stmt", "unknown_stmt"
	];
